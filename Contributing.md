...
- Make sure the extension is useful before submitting. That implies it has enough content and every item has a good succinct description.
...
1. Access the awesome list's GitHub page. For example: https://github.com/refinerycms-contrib/awesome-refinerycms
